...
import pers.pandora.common.aop.AOPProxyFactory;
import pers.pandora.common.orm.DBPool;
import pers.pandora.common.orm.Transaction;
import pers.pandora.common.orm.Transactional;
import pers.pandora.common.web.Controller;
import pers.pandora.common.web.Service;
import pers.pandora.common.web.WebSocket;
import pers.pandora.common.constant.LOG;
import pers.pandora.om.annotation.*;
...
public final class BeanPool {
    ...
    private static final String BEAN_POOL_CLASS = "BeanPool";
