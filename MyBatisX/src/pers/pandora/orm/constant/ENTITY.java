...
public class ENTITY {
    ...
    public static final String IMPORT_HEAD = "pers.pandora.orm.annotation.*";
    ...
    public static final String JAVA_MARK = "java";
    ...
    public static final String QUERYBYID = "queryForOne";
