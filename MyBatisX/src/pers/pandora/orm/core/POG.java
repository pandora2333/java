...
import pers.pandora.common.orm.DBPool;
import pers.pandora.common.orm.DataBaseCoder;
import pers.pandora.common.orm.PoolConnection;
import pers.pandora.common.utils.StringUtils;
import pers.pandora.orm.constant.ENTITY;
import pers.pandora.orm.constant.SQL;
import pers.pandora.orm.constant.XML;
import pers.pandora.orm.pog.ColumnInfo;
import pers.pandora.orm.pog.JavaGetSetter;
import pers.pandora.orm.pog.TableInfo;
import pers.pandora.orm.utils.Dom4JUtil;
import pers.pandora.orm.utils.TypeConverter;
...
public class POG {
    ...
    public POG(final String dbProperties) {
        if (StringUtils.isNotEmpty(dbProperties)) {
